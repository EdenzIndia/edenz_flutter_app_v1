...
.method private g(Lio/flutter/embedding/android/k;)V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->u()Lio/flutter/embedding/android/o;
...
.method private h()V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->l()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/engine/f/b;->k()Z
    ...
    invoke-virtual {v0}, Lh/a/a;->c()Lio/flutter/embedding/engine/h/d;
    ...
    invoke-virtual {v0, v1}, Lio/flutter/embedding/engine/f/b;->h(Lio/flutter/embedding/engine/f/b$b;)V
...
.method private n(Landroid/content/Intent;)Ljava/lang/String;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->s()Z
...
.method A(Landroid/os/Bundle;)V
    ...
    invoke-interface {v1, v0}, Lio/flutter/embedding/engine/i/c/b;->d(Landroid/os/Bundle;)V
...
.method D(I)V
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/f/b;->l()V
...
.method E()V
    ...
    invoke-interface {v0}, Lio/flutter/embedding/engine/i/c/b;->e()V
...
.method G()V
    ...
    invoke-interface {v1}, Lio/flutter/embedding/android/f$c;->l()Ljava/lang/String;
    ...
    invoke-interface {v1, v3}, Lio/flutter/embedding/android/f$c;->w(Landroid/content/Context;)Lio/flutter/embedding/engine/b;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/f$c;->t()Lio/flutter/embedding/engine/e;
    ...
    invoke-interface {v3}, Lio/flutter/embedding/android/f$c;->m()Z
...
.method p(Landroid/content/Context;)V
    ...
    invoke-interface {p1}, Lio/flutter/embedding/android/f$c;->j()Z
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/f$c;->b()Landroidx/lifecycle/d;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lio/flutter/embedding/engine/i/c/b;->f(Lio/flutter/embedding/android/d;Landroidx/lifecycle/d;)V
    ...
    invoke-interface {p1, v0, v1}, Lio/flutter/embedding/android/f$c;->p(Landroid/app/Activity;Lio/flutter/embedding/engine/b;)Lio/flutter/plugin/platform/f;
    ...
    invoke-interface {p1, v0}, Lio/flutter/embedding/android/f$c;->z(Lio/flutter/embedding/engine/b;)V
...
.method r(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;IZ)Landroid/view/View;
    ...
    invoke-interface {p2}, Lio/flutter/embedding/android/f$c;->u()Lio/flutter/embedding/android/o;

    move-result-object p2

    sget-object p3, Lio/flutter/embedding/android/o;->n:Lio/flutter/embedding/android/o;
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/f$c;->x()Lio/flutter/embedding/android/r;

    move-result-object v2

    sget-object v3, Lio/flutter/embedding/android/r;->o:Lio/flutter/embedding/android/r;
    ...
    invoke-interface {p3}, Lio/flutter/embedding/android/f$c;->x()Lio/flutter/embedding/android/r;

    move-result-object p3

    sget-object v2, Lio/flutter/embedding/android/r;->n:Lio/flutter/embedding/android/r;
    ...
    invoke-interface {p3, p2}, Lio/flutter/embedding/android/f$c;->y(Lio/flutter/embedding/android/j;)V
    ...
    invoke-interface {p2}, Lio/flutter/embedding/android/f$c;->v()Lio/flutter/embedding/android/q;
    ...
    invoke-static {p3}, Lh/a/d/d;->a(I)I
...
.method t()V
    ...
    invoke-interface {v1, v2}, Lio/flutter/embedding/android/f$c;->o(Lio/flutter/embedding/engine/b;)V

    iget-object v1, p0, Lio/flutter/embedding/android/f;->a:Lio/flutter/embedding/android/f$c;

    invoke-interface {v1}, Lio/flutter/embedding/android/f$c;->j()Z
    ...
    invoke-interface {v2}, Lio/flutter/embedding/android/f$c;->l()Ljava/lang/String;
...
.method u(Landroid/content/Intent;)V
    ...
    invoke-interface {v0, p1}, Lio/flutter/embedding/engine/i/c/b;->b(Landroid/content/Intent;)V
...
.method y(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Lio/flutter/embedding/engine/i/c/b;->c(Landroid/os/Bundle;)V
