...
.field private final d:Lh/a/c/a/a$d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lh/a/c/a/a$d<",
            "Ljava/lang/Object;",
...
.method public constructor <init>(Lio/flutter/embedding/engine/f/b;Lio/flutter/embedding/engine/FlutterJNI;)V
    ...
    iput-object v0, p0, Lio/flutter/embedding/engine/j/b;->d:Lh/a/c/a/a$d;

    new-instance v1, Lh/a/c/a/a;

    sget-object v2, Lh/a/c/a/q;->a:Lh/a/c/a/q;

    const-string v3, "flutter/accessibility"

    invoke-direct {v1, p1, v3, v2}, Lh/a/c/a/a;-><init>(Lh/a/c/a/b;Ljava/lang/String;Lh/a/c/a/h;)V

    iput-object v1, p0, Lio/flutter/embedding/engine/j/b;->a:Lh/a/c/a/a;

    invoke-virtual {v1, v0}, Lh/a/c/a/a;->e(Lh/a/c/a/a$d;)V
