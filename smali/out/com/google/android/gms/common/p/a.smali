...
.method private final f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    invoke-virtual {v2, p6, v1}, Lcom/google/android/gms/common/q/b;->b(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_29
    :goto_29
    invoke-static {p4}, Lcom/google/android/gms/common/p/a;->g(Landroid/content/ServiceConnection;)Z
    ...
    :cond_53
    :try_start_53
    invoke-static {p1, p3, p4, p5, p7}, Lcom/google/android/gms/common/p/a;->h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
...
.method public a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    invoke-direct/range {v1 .. v8}, Lcom/google/android/gms/common/p/a;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/common/p/a;->g(Landroid/content/ServiceConnection;)Z
    ...
    invoke-static {p1, v0}, Lcom/google/android/gms/common/p/a;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_19
    ...
    :cond_26
    invoke-static {p1, p2}, Lcom/google/android/gms/common/p/a;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    invoke-direct/range {v0 .. v7}, Lcom/google/android/gms/common/p/a;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
