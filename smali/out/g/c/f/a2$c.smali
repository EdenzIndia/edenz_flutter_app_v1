...
.method private static m([BII)I
    ...
    :cond_d
    invoke-static {p0, p1, p2}, Lg/c/f/a2$c;->n([BII)I
...
.method private static n([BII)I
    ...
    invoke-static {p0, v0, p2}, Lg/c/f/a2;->c([BII)I
...
.method e(Ljava/lang/CharSequence;[BII)I
    ...
    :cond_ba
    new-instance p1, Lg/c/f/a2$d;

    add-int/lit8 v1, v1, -0x1

    invoke-direct {p1, v1, v0}, Lg/c/f/a2$d;-><init>(II)V
...
.method i(I[BII)I
    ...
    :cond_82
    :goto_82
    invoke-static {p2, p3, p4}, Lg/c/f/a2$c;->m([BII)I
