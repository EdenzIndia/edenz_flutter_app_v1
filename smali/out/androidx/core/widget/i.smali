...
.method public static e(Landroid/widget/TextView;)Le/f/i/a$a;
    .registers 5
    ...
    new-instance v0, Le/f/i/a$a;

    invoke-virtual {p0}, Landroid/widget/TextView;->getTextMetricsParams()Landroid/text/PrecomputedText$Params;

    move-result-object p0

    invoke-direct {v0, p0}, Le/f/i/a$a;-><init>(Landroid/text/PrecomputedText$Params;)V

    return-object v0

    :cond_10
    new-instance v1, Le/f/i/a$a$a;
    ...
    invoke-direct {v1, v2}, Le/f/i/a$a$a;-><init>(Landroid/text/TextPaint;)V
    ...
    invoke-virtual {v1, v2}, Le/f/i/a$a$a;->b(I)Le/f/i/a$a$a;

    invoke-virtual {p0}, Landroid/widget/TextView;->getHyphenationFrequency()I

    move-result v2

    invoke-virtual {v1, v2}, Le/f/i/a$a$a;->c(I)Le/f/i/a$a$a;
    ...
    invoke-virtual {v1, p0}, Le/f/i/a$a$a;->d(Landroid/text/TextDirectionHeuristic;)Le/f/i/a$a$a;

    :cond_3b
    invoke-virtual {v1}, Le/f/i/a$a$a;->a()Le/f/i/a$a;
...
.method public static h(Landroid/widget/TextView;I)V
    ...
    invoke-static {p1}, Le/f/j/d;->a(I)I
...
.method public static k(Landroid/widget/TextView;Le/f/i/a;)V
    .registers 4
    ...
    invoke-virtual {p1}, Le/f/i/a;->b()Landroid/text/PrecomputedText;
    ...
    invoke-virtual {p1}, Le/f/i/a;->a()Le/f/i/a$a;

    move-result-object v1

    invoke-virtual {v0, v1}, Le/f/i/a$a;->a(Le/f/i/a$a;)Z
...
.method public static l(Landroid/widget/TextView;Le/f/i/a$a;)V
    .registers 4
