...
.method private final addListener(Ljava/util/concurrent/Executor;Le/f/j/a;Lkotlinx/coroutines/k2/b;)V
    .registers 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {p1}, Lkotlinx/coroutines/l0;->a(Li/v/g;)Lkotlinx/coroutines/k0;
    ...
    invoke-direct {v4, p3, p2, v5}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter$addListener$1$1;-><init>(Lkotlinx/coroutines/k2/b;Le/f/j/a;Li/v/d;)V

    const/4 v5, 0x3

    const/4 v6, 0x0

    invoke-static/range {v1 .. v6}, Lkotlinx/coroutines/i;->b(Lkotlinx/coroutines/k0;Li/v/g;Lkotlinx/coroutines/m0;Li/y/c/p;ILjava/lang/Object;)Lkotlinx/coroutines/n1;
...
.method private final removeListener(Le/f/j/a;)V
    .registers 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public final addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Le/f/j/a;)V
    .registers 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, p3, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addListener(Ljava/util/concurrent/Executor;Le/f/j/a;Lkotlinx/coroutines/k2/b;)V

    return-void
.end method

.method public final removeWindowLayoutInfoListener(Le/f/j/a;)V
    .registers 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->removeListener(Le/f/j/a;)V
